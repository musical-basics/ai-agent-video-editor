...
7. **Timeline Review:** Human scans the horizontally scrollable rough-cut timeline, uses the playback cursor and transport controls, presses space to toggle playback, selects clips, and checks the preview pane for the exact region that needs work.
